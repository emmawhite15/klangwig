...
- In R, go to file--> new project --> version control-->git-->copy and paste the directory name
- make sure klangwig fills in as the name of the directory
- **Store in the class folder that you can find!**
- Each class --double click klangwig.Rproj and pull
- Open the R script le2.R so you can run it while I talk
